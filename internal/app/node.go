...
func NewNode(c Config) *Node {
	n := &Node{cfg: c, pool: mempool.New(1000), state: state_machine.New(), repo: repository.New(), peers: p2p.New(), bft: consensus.New(c.Network.Validators), audit: audit.New(), metrics: observability.New()}
